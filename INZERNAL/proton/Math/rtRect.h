...
{
	rtRect32();
	rtRect32(int32_t l, int32_t t, int32_t r, int32_t b) : left(l), top(t), right(r), bottom(b) {};
	...
	void AdjustPosition(int32_t x, int32_t y); //move the rect by repositioning the upper left hand corner
	void Inflate(int32_t x, int32_t y);
};
